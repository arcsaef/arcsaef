...
AND a.position in ('Associate Investigator', 'Chief Investigator',
 'Partner Investigator')
AND a.start_dt <= '2023-12-31' -- Commenced b/4 the end of calendar year
AND a.end_dt > '2022-12-31' OR a.end_dt is NULL -- Terminated after start of calendar year or on going
ORDER BY 1, 2
